...
当前源码候选为 `3.11.5`；正式 Z 快照仍为 `3.11.4`，直至本版本发布。`HistoryVulcan.Core` 公开面自 `3.9.0` 起冻结。
...
宿主候选位于 `b-Publish/current`。当前正式快照为 3.11.4：运行入口 `z-HistoryVulcan/host/HistoryVulcan.exe`。
